...
function controleer() {
    ...
    if (punten == 5) {
        document.getElementById("goedeantwoorden").innerHTML = "Gefeliciteerd! Alle antwoorden zijn goed!";
    } else {
        document.getElementById("goedeantwoorden").innerHTML = punten + " van jouw vijf antwoorden zijn goed!";
    }
}